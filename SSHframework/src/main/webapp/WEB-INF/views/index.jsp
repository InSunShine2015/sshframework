...
<body data-type="index">
    ...
    <div class="am-g tpl-g">
        ...
        <header>
            ...
            <div class="am-fl tpl-header-logo">
                <a href="javascript:;"><img src="<%=basePath%>/static/assets/img/logo.png" alt=""></a>
            </div>
            <!-- 右侧内容 -->
                        ...
                        <li class="am-dropdown tpl-dropdown" data-am-dropdown>
                            ...
                            <ul class="am-dropdown-content tpl-dropdown-content">
                                <li class="tpl-dropdown-menu-messages">
                                    <a href="javascript:;" class="tpl-dropdown-menu-messages-item am-cf">
                                        <div class="menu-messages-ico">
                                            <img src="<%=basePath%>/static/assets/img/user04.png" alt="">
                                        </div>
                                ...
                                <li class="tpl-dropdown-menu-messages">
                                    <a href="javascript:;" class="tpl-dropdown-menu-messages-item am-cf">
                                        <div class="menu-messages-ico">
                                            <img src="<%=basePath%>/static/assets/img/user02.png" alt="">
                                        </div>
                                        <div class="menu-messages-time">
                                            5天前
                                        </div>
        ...
        <div class="left-sidebar">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-nav-link">
                    <a href="<%=basePath %>/uploadExcel/toUpload.do" class="active">
                        <i class="sidebar-nav-link-logo"></i> 上传渠道文件
                    </a>
                </li>
                <li class="sidebar-nav-link">
                    <a href="tables.html">
                        <i class="sidebar-nav-link-logo"></i> 表格
                    </a>
                </li>
                <li class="sidebar-nav-link">
                ...
                <li class="sidebar-nav-link">
                    <a href="login.html">
                        <i class="sidebar-nav-link-logo"></i> 登录
                    </a>
                </li>
                <li class="sidebar-nav-link">
                    <a href="404.html">
                ...
                <div class="row am-cf">
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-4 widget-margin-bottom-lg ">
                        <div class="tpl-user-card am-text-center widget-body-lg">
                            ...
                            <img class="achievement-image" src="<%=basePath%>/static/assets/img/user07.png" alt="">
    ...
    <script src="<%=basePath%>/static/assets/js/amazeui.datatables.min.js"></script>
    <script src="<%=basePath%>/static/assets/js/dataTables.responsive.min.js"></script>
